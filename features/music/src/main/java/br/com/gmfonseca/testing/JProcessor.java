package br.com.gmfonseca.testing;//package br.com.gmfonseca.testing;
//
...
//            boolean assignable = processingEnv.getTypeUtils().isAssignable(it.asType(), processingEnv.getElementUtils().getTypeElement("Command").asType());
//            if (assignable) {
//                b.add(element);
//            } else {
