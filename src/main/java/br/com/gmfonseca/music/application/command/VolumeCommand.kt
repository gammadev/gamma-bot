...
class VolumeCommand : Command() {
    ...
    override fun onCommand(author: User, channel: TextChannel, args: List<String>): Boolean {
        ...
        return if (musicManager.scheduler.switchVolume(volume)) {
            EmbedMessage.success(channel, title = "Volume alterado", description = "Agora o volume é $volume") {
