...
import br.com.gmfonseca.bot.music.data.repositories.AudioPlayerRepository
...
object MusicManager : AppManager {
    ...
    private val audioPlayerRepository = AudioPlayerRepository(AudioPlayerManagerFactoryImpl(PLAYER_MANAGER))
    ...
    fun clearMusicManager(guildId: String) = audioPlayerRepository.remove(guildId.toLong())
